...
export default function WebLiveHub() {
  ...
  return (
    <div className="min-h-screen bg-[#FFFDF8] text-gray-900 pt-24 pb-20 font-sans">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {isLoading ? (
          ...
          <>
            ...
            {/* Compliance Banner */}
            <div className="bg-green-50 border border-green-200 rounded-xl p-4 flex items-start gap-3 mt-12 shadow-sm">
      ...
      {selectedVideo && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 md:p-8">
          ...
          <div className="w-full max-w-5xl bg-white rounded-2xl overflow-hidden border border-gray-200 shadow-2xl flex flex-col max-h-[90vh]">
...
function LiveCard({ stream, onClick }: { stream: LiveStream, onClick: () => void }) {
  ...
  return (
    <div 
      onClick={onClick}
      className="group bg-white rounded-2xl overflow-hidden border border-gray-200 shadow-sm hover:border-gray-300 transition-all duration-300 cursor-pointer hover:-translate-y-1 hover:shadow-xl"
    >
      {/* Thumbnail */}
...
function WebCountdown({ targetIso }: { targetIso: string }) {
  ...
  return (
    <div className={`inline-flex items-center gap-1.5 px-2 py-1 rounded border ${isImminent ? 'bg-red-50 border-red-200' : 'bg-gray-50 border-gray-200'}`}>
